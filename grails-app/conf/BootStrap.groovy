		...
		environments {
			development {
				if (!Company.count()) {
					...
					def inv362 = new Invoice(job:sonicEsb, invoiceNumber:'362', deliveryMethod:'Email', deliveryStatus:'Pending', other:'Mar 1 - 31, 2012').save(failOnError: true, flush:true)
