...
<body>
	<a href="#edit-invoice" class="skip" tabindex="-1"><g:message
	...
	<div id="fileUpload">
		...
		--%>
		<% 
		def path = new File("${invoiceInstance?.invoiceNumber}")
		%>
		<uploadr:add name="myFirstUploadr"
			controller="attachment" action="upload"
			path="${path}"
			direction="up" maxVisible="5"
